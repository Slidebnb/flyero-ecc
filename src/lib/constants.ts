...
export const ORDER_STATUS_TRANSITIONS: Record<OrderStatus, OrderStatus[]> = {
  ...
  SUBMITTED: ["PAYMENT_PENDING", "UNDER_REVIEW", "WAITING_FOR_CUSTOMER", "APPROVED", "REJECTED", "CANCELLED"],
  PAID_WAITING_FOR_ADMIN_REVIEW: ["APPROVED", "REJECTED", "WAITING_FOR_CUSTOMER", "CANCELLED"],
  UNDER_REVIEW: ["APPROVED", "PAYMENT_PENDING", "REJECTED", "WAITING_FOR_CUSTOMER", "CANCELLED"],
