  ...
  return (
    <PortalShell eyebrow="Lager" title="Lieferungen" description="Erwartete Lieferungen prüfen, beschädigte Ware melden und Wareneingänge bestätigen." navItems={[
      ...
      <DataSection title="Erwartete Lieferungen">
        <div className="tableWrap"><table><thead><tr><th>Auftrag</th><th>Kunde</th><th>Typ</th><th>Status</th><th>Tracking</th><th>Aktion</th></tr></thead><tbody>
          ...
          {shipments.length === 0 ? <tr><td colSpan={6}>Keine Lieferungen für dieses Lager.</td></tr> : null}
        </tbody></table></div>
      </DataSection>
    </PortalShell>
  );
