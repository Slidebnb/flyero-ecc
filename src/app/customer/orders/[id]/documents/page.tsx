...
export default async function CustomerOrderDocumentsPage({ params }: PageProps) {
  ...
  return (
    <CustomerPortalShell active="/customer/documents" title={`Dokumente ${order.orderNumber}`} description={order.targetAreaName}>
      <div className="customerActionRow">
        <Link className="secondaryButton" href="/customer/documents">Dokumentencenter</Link>
        <Link className="secondaryButton" href={`/customer/orders/${id}`}>Auftrag</Link>
      ...
      <DataSection title="Chronologische Dokumente">
        <div className="tableWrap">
          <table>
            <thead><tr><th>Dokument</th><th>Typ</th><th>Status</th><th>Versionen</th><th></th></tr></thead>
            <tbody>
