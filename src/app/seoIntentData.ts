...
export const seoIntentPages: SeoIntentPageData[] = [
  ...
  },
  {
    ...
    label: "Bendorf",
    title: "Flyerverteilung Bendorf: Gebiet wählen, Preis prüfen, Nachweis erhalten.",
    description:
      "Flyerverteilung in Bendorf und Umgebung mit FLYERO: Gebiet online auswählen, eigene Flyer anliefern, Auftrag buchen oder anfragen und Nachweise im Kundenkonto erhalten.",
    keywords: ["Flyerverteilung Bendorf", "Flyer verteilen Bendorf", "Prospektverteilung Bendorf", "Haushaltswerbung Bendorf"],
    areaServed: ["Bendorf", "Sayn", "Mülhofen", "Stromberg", "Weitersburg", "Neuwied", "Koblenz"],
    eyebrow: "Raum Bendorf",
    lead:
      "FLYERO hilft Unternehmen im Raum Bendorf, Flyer- und Prospektkampagnen sauber zu planen: Gebiet auswählen, Menge festlegen, eigene Drucksachen anliefern und nach der Durchführung freigegebene Nachweise erhalten.",
    asideTitle: "Für lokale Aktionen rund um Bendorf.",
    asidePoints: ["Bendorf und Stadtteile planen", "Nachbarorte als Teilgebiete ergänzen", "Nachweise nach der Verteilung erhalten"],
    sections: [
      {
        eyebrow: "Einsatz",
        title: "Flyerverteilung für Bendorf und direkte Umgebung.",
        text: "Ob Geschäft, Praxis, Verein, Gastronomie oder Dienstleister: In Bendorf zählt ein klar begrenztes Gebiet, damit die Verteilung zur lokalen Zielgruppe passt.",
        points: ["Sayn und Mülhofen", "Stromberg und Weitersburg", "Kampagnen mit Neuwied oder Koblenz kombinieren"],
      },
      {
        eyebrow: "Planung",
        title: "Ort oder PLZ eingeben und Gebiet auswählen.",
        text: "Im Planer starten Sie mit Bendorf oder einer PLZ, wählen die passende Fläche und können bei Bedarf weitere Teilgebiete hinzufügen.",
        points: ["Gebiet sichtbar auf der Karte", "mehrere Teilgebiete möglich", "Preisvorschau vor dem Absenden"],
      },
      {
        eyebrow: "Nachweis",
        title: "Nach Abschluss bleiben Unterlagen greifbar.",
        text: "Nach der Durchführung stellt FLYERO freigegebene Nachweise und den PDF-Bericht im Kundenkonto bereit.",
        points: ["GPS-Unterlagen nach Durchführung", "Foto-Dokumentation nach Freigabe", "PDF-Bericht zum Download"],
      },
    ],
    faq: [
      { question: "Kann ich Bendorf zusammen mit Neuwied oder Koblenz planen?", answer: "Ja. Mehrere Orte können als Teilgebiete in einer Kampagne zusammengeführt werden." },
    ...
    relatedLinks: [
      ...
      ["Gebiet und Preis prüfen", "/verteilung-planen"],
      ["Unverbindlich anfragen", "/verteilung-anfragen"],
    ],
    schemaKind: "service",
  },
  {
    ...
    description:
      "Flyerverteilung in Koblenz planen: Gebiet online auswählen, Flyer anliefern, Preisvorschau prüfen und Nachweise nach der Verteilung im Kundenkonto erhalten.",
    keywords: ["Flyerverteilung Koblenz", "Flyer verteilen Koblenz", "Prospektverteilung Koblenz", "Haushaltswerbung Koblenz"],
    areaServed: ["Koblenz", "Altstadt", "Lützel", "Metternich", "Rauental", "Karthause", "Neuwied", "Bendorf"],
    eyebrow: "Raum Koblenz",
    lead:
      "Koblenz hat viele unterschiedliche Einzugsgebiete. FLYERO macht die Auswahl sichtbar: Sie legen die passende Fläche fest, bestimmen die Stückzahl und erhalten nach Abschluss freigegebene Unterlagen.",
    asideTitle: "Für Kampagnen in Koblenz und Nachbarorten.",
    asidePoints: ["Koblenzer Stadtteile gezielt planen", "Teilgebiete ergänzen", "Nachweise im Kundenkonto erhalten"],
    sections: [
      {
        ...
        points: ["Innenstadt und Altstadt", "Metternich, Lützel und Rauental", "Kombination mit Bendorf oder Neuwied"],
      },
      {
        eyebrow: "Ablauf",
        ...
        points: ["PLZ, Ort oder Adresse nutzen", "Fläche sichtbar auswählen", "Auftrag oder Anfrage starten"],
      },
      {
        eyebrow: "Dokumentation",
        title: "Verteilung nachvollziehbar abschliessen.",
        text: "Nachweise werden erst nach Durchführung und Freigabe bereitgestellt. So bleibt der Abschluss ehrlich und belastbar.",
        points: ["GPS-Nachweis", "Foto-Dokumentation", "PDF-Bericht"],
      },
    ],
    faq: [
      { question: "Kann ich nur einzelne Koblenzer Stadtteile auswählen?", answer: "Wenn passende Flächen verfügbar sind, können einzelne Bereiche ausgewählt und kombiniert werden." },
      { question: "Ist Koblenz direkt online buchbar?", answer: "Der Planer zeigt die aktuelle Buchungsmöglichkeit. Falls FLYERO ein Gebiet prüfen muss, führt der Ablauf zur unverbindlichen Anfrage." },
    ],
    relatedLinks: [
  ...
  },
  {
    ...
    description:
      "Flyerverteilung in Neuwied und Umgebung mit FLYERO: Gebiet auswählen, Preis prüfen, Empfangslager nutzen und Nachweise nach Abschluss herunterladen.",
    ...
    lead:
      "Im Raum Neuwied kann FLYERO lokale Kampagnen vom Gebiet bis zum Bericht abbilden. Sie wählen die Fläche, senden eigene gedruckte Flyer an das Empfangslager und erhalten nach Abschluss freigegebene Nachweise.",
    asideTitle: "Für Verteilungen in Neuwied und Umgebung.",
    asidePoints: ["Neuwied und Stadtteile planen", "Bendorf oder Koblenz ergänzen", "Empfangslager im Auftrag sehen"],
    sections: [
      {
        eyebrow: "Gebiet",
      ...
      },
      {
        ...
        points: ["Stückzahl festlegen", "Zeitraum wählen", "Empfangslager beachten"],
      },
      {
        eyebrow: "Nachweise",
        title: "Unterlagen nach der Durchführung.",
        text: "Freigegebene Nachweise und Berichte erscheinen im Kundenkonto und können dort heruntergeladen werden.",
        points: ["GPS-Unterlagen", "Fotos", "PDF-Abschlussbericht"],
      },
    ],
    faq: [
      { question: "Kann ich im Raum Neuwied mehrere Orte zusammen buchen?", answer: "Ja. Bendorf, Koblenz oder weitere Orte können als Teilgebiete in derselben Kampagne geplant werden." },
      { question: "Wo sende ich meine Flyer hin?", answer: "Das Empfangslager wird im Auftrag angezeigt. Für den aktuellen Betrieb ist Neuwied als Lagerstandort vorgesehen." },
    ],
    relatedLinks: [
      ["Flyerverteilung Bendorf", "/flyerverteilung-bendorf"],
      ["Flyerverteilung Koblenz", "/flyerverteilung-koblenz"],
