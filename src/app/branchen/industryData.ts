...
export const industryPages: IndustryPageData[] = [
  ...
  },
  {
    ...
    label: "Immobilien",
    iconKey: "property",
    title: "Flyerverteilung Immobilien: Ihre Objekte in der Wunschregion.",
    description: "Flyerverteilung für Immobilienmakler, Bauträger und Projektentwickler: Immobilienwerbung, Neubauprojekte und Kataloge gezielt in ausgewählten Wohngebieten verteilen.",
    keywords: ["Flyerverteilung Immobilien", "Flyerverteilung Immobilienmakler", "Immobilienwerbung", "Immobilien Flyer verteilen", "Immobilienmarketing lokal", "Haushaltswerbung Immobilien", "Flyer für Makler", "Neubauprojekt bewerben", "Immobilienbroschüre verteilen", "Immobilienkatalog verteilen"],
    heroLead: "Vermarkten Sie einzelne Objekte, mehrere Immobilien, Neubauprojekte oder Immobilienkataloge gezielt in ausgewählten Wohngebieten.",
    intro: "Ihre Immobilien sind online sichtbar. Erreichen Sie zusätzlich die Haushalte in den Gebieten, in denen potenzielle Käufer, Mieter oder Eigentümer tatsächlich wohnen.",
    ...
    faq: [
      ...
      { question: "Kann ich das Verteilgebiet selbst auswählen?", answer: "Ja. Sie wählen Ihr gewünschtes Gebiet online aus und sehen anschließend direkt den dazugehörigen Preis." },
      { question: "Kann FLYERO auch meine Immobilienbroschüre drucken?", answer: "Ja. Wenn Ihre Druckvorlage bereits fertig ist, können wir den Druck auf Anfrage für Sie organisieren. Die Kosten werden individuell kalkuliert." },
      { question: "Welche Nachweise erhalte ich nach der Verteilung?", answer: "Nach der Durchführung und Prüfung finden Sie Ihre GPS-, Foto- und PDF-Nachweise direkt in Ihrem Kundenkonto." },
    ],
  },
  {
    slug: "einzelhandel",
