...
assert.match(wizard, /initialLocation\?: PublicLocationContext \| null/);
...
assert.match(wizard, /contactPerson\?: string/);
assert.match(wizard, /contactPhone\?: string/);
assert.match(wizard, /notes\?: string/);
...
assert.doesNotMatch(wizard, /areaQuickList/);
  assert.match(wizard, /Gebiet auf der Karte zeichnen/);
