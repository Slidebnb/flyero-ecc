...
for (const key of ["ORDER_SUBMITTED", "ORDER_UNDER_REVIEW", "ORDER_CLARIFICATION_REQUESTED", "ORDER_ACCEPTED_PAYMENT_REQUIRED", "ORDER_APPROVED_CUSTOMER_FLYERS", "ORDER_APPROVED_PRINT_SERVICE", "ORDER_REJECTED", "ORDER_REFUND_STARTED", "INVOICE_AVAILABLE", "LOGISTICS_CUSTOMER_DELIVERY_EXPECTED", "DISPATCH_NEW_ORDER", "PAYMENT_FAILED"]) {
...
assert(/data:\s*\{\s*rejectionReason:/.test(reviewWorkflow), "Der Ablehnungsgrund muss als Template-Daten an die Kundenbenachrichtigung weitergereicht werden.");
