...
assert.match(smartMaps, /const singleAreaNeedsManualReview = Boolean\(!areaSelection && !warehouseMatch\?\.matchedRegion && !warehouseMatch\?\.isGlobalDefault\)/, "Einzelgebiete ohne aktive Region oder Standardlager erzwingen eine manuelle Prüfung.");
