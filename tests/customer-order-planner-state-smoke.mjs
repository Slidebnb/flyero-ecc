...
assert(constants.includes("export const MINIMUM_FLYER_QUANTITY = 1000"), "Die Mindestmenge muss zentral im Projekt auf 1.000 Stück gesetzt sein.");
...
assert(finishStep.includes("Wir prüfen Gebiet und Zustellung"), "Der Abschluss muss den Online-Prozess ohne Druckservice erklaeren.");
