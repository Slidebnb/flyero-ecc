...
const [schema, protection, leadRoute, verifyRoute, retention] = await Promise.all([
...
try {
  ...
  await prisma.publicRateLimitBucket.deleteMany({ where: { id: { in: [bucketId, verifyBucketId] } } });
