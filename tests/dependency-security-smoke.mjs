...
assert.equal(overrides.postcss, "8.5.28", "PostCSS muss auf dem gepatchten 8.5-Zweig festgeschrieben sein.");
...
assert.equal(lockfile.packages["node_modules/postcss"]?.version, "8.5.28", "Lockfile verwendet noch eine verwundbare PostCSS-Version.");
