...
assert(wizard.includes("setIntelligence(null)"), "Alte Kennzahlen müssen vor einer neuen Berechnung verschwinden.");
assert(wizard.includes("AbortController"), "Veraltete Berechnungsrequests müssen abbrechbar sein.");
